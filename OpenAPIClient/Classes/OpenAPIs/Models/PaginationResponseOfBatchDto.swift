//
// PaginationResponseOfBatchDto.swift
//
...
public final class PaginationResponseOfBatchDto: Codable, JSONEncodable, Hashable {

    public var items: [BatchDto]?
    ...
    public init(items: [BatchDto]? = nil, pageNumber: Int? = nil, totalPages: Int? = nil, totalCount: Int? = nil, pageSize: Int? = nil, hasPreviousPage: Bool? = nil, hasNextPage: Bool? = nil) {
        self.items = items
    ...
    public static func == (lhs: PaginationResponseOfBatchDto, rhs: PaginationResponseOfBatchDto) -> Bool {
        lhs.items == rhs.items &&
