//
// PaginationResponseOfZoneDto.swift
//
...
public final class PaginationResponseOfZoneDto: Codable, JSONEncodable, Hashable {

    public var items: [ZoneDto]?
    ...
    public init(items: [ZoneDto]? = nil, pageNumber: Int? = nil, totalPages: Int? = nil, totalCount: Int? = nil, pageSize: Int? = nil, hasPreviousPage: Bool? = nil, hasNextPage: Bool? = nil) {
        self.items = items
    ...
    public static func == (lhs: PaginationResponseOfZoneDto, rhs: PaginationResponseOfZoneDto) -> Bool {
        lhs.items == rhs.items &&
