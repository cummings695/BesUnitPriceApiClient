...
public final class ProductInfoViewModel: Codable, JSONEncodable, Hashable {
    ...
    public static func == (lhs: ProductInfoViewModel, rhs: ProductInfoViewModel) -> Bool {
        lhs.id == rhs.id &&
