...
public final class BaseInventoryItemViewModel: Codable, JSONEncodable, Hashable {
    ...
    public static func == (lhs: BaseInventoryItemViewModel, rhs: BaseInventoryItemViewModel) -> Bool {
        lhs.name == rhs.name &&
        lhs.notes == rhs.notes &&
