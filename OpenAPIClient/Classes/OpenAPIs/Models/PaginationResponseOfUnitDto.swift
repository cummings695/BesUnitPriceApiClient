//
// PaginationResponseOfUnitDto.swift
//
...
public final class PaginationResponseOfUnitDto: Codable, JSONEncodable, Hashable {

    public var items: [UnitDto]?
    ...
    public init(items: [UnitDto]? = nil, pageNumber: Int? = nil, totalPages: Int? = nil, totalCount: Int? = nil, pageSize: Int? = nil, hasPreviousPage: Bool? = nil, hasNextPage: Bool? = nil) {
        self.items = items
    ...
    public static func == (lhs: PaginationResponseOfUnitDto, rhs: PaginationResponseOfUnitDto) -> Bool {
        lhs.items == rhs.items &&
