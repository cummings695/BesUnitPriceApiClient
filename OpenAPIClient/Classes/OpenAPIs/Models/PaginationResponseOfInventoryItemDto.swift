//
// PaginationResponseOfInventoryItemDto.swift
//
...
public final class PaginationResponseOfInventoryItemDto: Codable, JSONEncodable, Hashable {
    ...
    public init(items: [InventoryItemDto]? = nil, pageNumber: Int? = nil, totalPages: Int? = nil, totalCount: Int? = nil, pageSize: Int? = nil, hasPreviousPage: Bool? = nil, hasNextPage: Bool? = nil) {
        self.items = items
    ...
    public static func == (lhs: PaginationResponseOfInventoryItemDto, rhs: PaginationResponseOfInventoryItemDto) -> Bool {
        lhs.items == rhs.items &&
