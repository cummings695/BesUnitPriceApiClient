...
public final class PostVendorViewModel: Codable, JSONEncodable, Hashable {
    ...
    public var minimumOrder: Float?
    public var accountNumber: String?
    public var orderTotal: Float?
    public var incentivePercentage: Float?
    ...
    public static func == (lhs: PostVendorViewModel, rhs: PostVendorViewModel) -> Bool {
        lhs.name == rhs.name &&
