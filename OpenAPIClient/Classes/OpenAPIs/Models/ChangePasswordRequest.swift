...
public final class ChangePasswordRequest: Codable, JSONEncodable, Hashable {
    ...
    public static func == (lhs: ChangePasswordRequest, rhs: ChangePasswordRequest) -> Bool {
        ...
        lhs.confirmNewPassword == rhs.confirmNewPassword
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(confirmNewPassword?.hashValue)
